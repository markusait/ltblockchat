...
// let enc = new EncryptionHelper(passsword)
// console.log(enc.getKeyAndIV());
// console.log(crypto.randomBytes(16).toString('hex'));

// console.log(encryptionHelper.getKeyAndIV())
...
encryptionHelper.getKeyAndIV(passsword, callbackf)

function callbackf(data) { //using 32 byte key
  var encText = encryptionHelper.encryptText(algorithm, data.key, data.iv, story, "base64");
  output(encryptionHelper.encryptText(algorithm, data.key, data.iv, story, "base64"))
...
//       let keyBuffer = (this.key instanceof Buffer) ? this.key : new Buffer(this.key);
//       console.log(JSON.stringify(ivBuffer),JSON.stringify(keyBuffer));
//       return {
//         hi : 'orc'
//         // iv: JSON.stringify(ivBuffer),
//         // key: JSON.stringify(keyBuffer)
//       }
//     })
//   }
//
